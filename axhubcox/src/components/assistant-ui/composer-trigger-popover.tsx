  ...
  return (
    <ComposerPrimitive.Unstable_TriggerPopoverItems>
      {(items) => (
        ...
        >
          <ComposerPrimitive.Unstable_TriggerPopoverBack className="flex cursor-pointer items-center gap-1.5 border-b px-3 py-2 text-muted-foreground text-xs transition-colors hover:bg-accent">
...
const ComposerTriggerPopoverImpl: FC<ComposerTriggerPopoverProps> = ({
  ...
  return (
    <ComposerPrimitive.Unstable_TriggerPopover
      ...
      className={cn(
        'aui-composer-trigger-popover absolute start-0 bottom-full z-[1300] mb-2 w-64 overflow-hidden rounded-md border bg-popover p-0 text-popover-foreground shadow-md',
        className,
      )}
      {...props}
    >
