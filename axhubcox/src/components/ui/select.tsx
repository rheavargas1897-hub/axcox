...
const SelectTrigger = React.forwardRef<
    ...
    SelectTriggerProps
>(({ className, children, clearable = false, hasValue = false, onClear, disabled, ...props }, ref) => (
...
>(({ className, children, position = 'popper', ...props }, ref) => (
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ref={ref}
            className={cn(
                'relative z-[120] max-h-96 min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out',
                position === 'popper' &&
