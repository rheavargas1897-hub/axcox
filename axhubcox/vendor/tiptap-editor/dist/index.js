...
import { useEffect as useEffect23, useRef as useRef7, useState as useState26 } from "react";
...
var NodeBackground = Extension.create({
  name: "nodeBackground",
  addOptions() {
    return {
      types: [
...
// src/components/tiptap-ui-primitive/button/button.tsx
import "./button-colors-CVSZJKQQ.scss";
import "./button-group-JZXNMEYG.scss";
import "./button-AUYFQ46A.scss";
...
function Spacer({
  ...
  return /* @__PURE__ */ jsx3("div", { ...props, style: computedStyle });
}

// src/components/tiptap-ui-primitive/toolbar/toolbar.tsx
import { forwardRef as forwardRef4, useCallback as useCallback2, useEffect as useEffect2, useRef as useRef2, useState as useState3 } from "react";

// src/components/tiptap-ui-primitive/separator/separator.tsx
import { forwardRef as forwardRef3 } from "react";
import "./separator-I6JCHKGD.scss";
...
var ToolbarGroup = forwardRef4(
  ({ children, className, ...props }, ref) => /* @__PURE__ */ jsx5(
    "div",
    {
      ref,
      role: "group",
...
var ToolbarSeparator = forwardRef4(
  ({ ...props }, ref) => /* @__PURE__ */ jsx5(Separator, { ref, orientation: "vertical", decorative: true, ...props })
);
...
// src/components/tiptap-node/image-upload-node/image-upload-node.tsx
import "./image-upload-node-MMJ7L2OD.scss";
...
var FileCornerIcon = () => /* @__PURE__ */ jsx7(
  "svg",
  {
    width: "10",
    height: "10",
...
var ImageUploadPreview = ({
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "tiptap-image-upload-preview", children: [
    fileItem.status === "uploading" && /* @__PURE__ */ jsx7(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs2("div", { className: "tiptap-image-upload-preview-content", children: [
      /* @__PURE__ */ jsxs2("div", { className: "tiptap-image-upload-file-info", children: [
        /* @__PURE__ */ jsx7("div", { className: "tiptap-image-upload-file-icon", children: /* @__PURE__ */ jsx7(CloudUploadIcon, {}) }),
        /* @__PURE__ */ jsxs2("div", { className: "tiptap-image-upload-details", children: [
          /* @__PURE__ */ jsx7("span", { className: "tiptap-image-upload-text", children: fileItem.file.name }),
          /* @__PURE__ */ jsx7("span", { className: "tiptap-image-upload-subtext", children: formatFileSize(fileItem.file.size) })
        ] })
      ] }),
...
var DropZoneContent = ({
  ...
  /* @__PURE__ */ jsxs2("div", { className: "tiptap-image-upload-dropzone", children: [
    ...
    /* @__PURE__ */ jsx7(FileCornerIcon, {}),
    /* @__PURE__ */ jsx7("div", { className: "tiptap-image-upload-icon-container", children: /* @__PURE__ */ jsx7(CloudUploadIcon, {}) })
  ] }),
  /* @__PURE__ */ jsxs2("div", { className: "tiptap-image-upload-content", children: [
    /* @__PURE__ */ jsxs2("span", { className: "tiptap-image-upload-text", children: [
      /* @__PURE__ */ jsx7("em", { children: "\u70B9\u51FB\u4E0A\u4F20" }),
      " \u6216\u62D6\u62FD\u6587\u4EF6\u5230\u6B64"
    ] }),
...
var ImageUploadNode = (props) => {
  ...
  return /* @__PURE__ */ jsxs2(
    NodeViewWrapper,
    {
      ...
      onClick: handleClick,
      children: [
        !hasFiles && /* @__PURE__ */ jsx7(ImageUploadDragArea, { onFile: handleUpload, children: /* @__PURE__ */ jsx7(DropZoneContent, { maxSize, limit }) }),
        hasFiles && /* @__PURE__ */ jsxs2("div", { className: "tiptap-image-upload-previews", children: [
          ...
          fileItems.map((fileItem) => /* @__PURE__ */ jsx7(
            ImageUploadPreview,
            {
              fileItem,
...
import { useEffect as useEffect3, useMemo as useMemo3, useRef as useRef4, useState as useState5 } from "react";
import { NodeViewWrapper as NodeViewWrapper2 } from "@tiptap/react";
import "./resizable-image-node-AIVWHM7E.scss";
      ...
      children: /* @__PURE__ */ jsxs3(
        "div",
        {
          ...
          children: [
            ...
            selected && editor?.isEditable && /* @__PURE__ */ jsx8(
              "button",
              {
                type: "button",
...
import { mergeAttributes as mergeAttributes2 } from "@tiptap/react";
import TiptapHorizontalRule from "@tiptap/extension-horizontal-rule";
var HorizontalRule = TiptapHorizontalRule.extend({
  renderHTML() {
    return [
      "div",
      mergeAttributes2(this.options.HTMLAttributes, { "data-type": this.name }),
      ["hr"]
    ];
  }
});
...
// src/components/tiptap-templates/simple/simple-editor.tsx
import "./blockquote-node-BJHVYE5D.scss";
import "./code-block-node-DSDMPXAT.scss";
import "./horizontal-rule-node-NM7YFYPM.scss";
import "./list-node-VF4TU7T4.scss";
import "./heading-node-BYFDWV4U.scss";
import "./paragraph-node-4PTN4ABT.scss";

// src/components/tiptap-ui/heading-dropdown-menu/heading-dropdown-menu.tsx
import { forwardRef as forwardRef9, useCallback as useCallback5, useState as useState7 } from "react";
...
import "./badge-colors-4TD6XHO3.scss";
import "./badge-group-3G7S33KS.scss";
import "./badge-2EHNGFC5.scss";
...
function HeadingShortcutBadge({
  ...
  return /* @__PURE__ */ jsx11(Badge, { children: parseShortcutKeys({ shortcutKeys }) });
}
    ...
    return /* @__PURE__ */ jsx11(
      Button,
      {
        ...
        children: children ?? /* @__PURE__ */ jsxs4(Fragment3, { children: [
          /* @__PURE__ */ jsx11(Icon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx11("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx11(HeadingShortcutBadge, { level, shortcutKeys })
        ] })
      }
    );
  }
...
function toggleHeading(editor, level) {
  ...
  try {
    ...
    if ((state.selection.empty || state.selection instanceof TextSelection2) && isPossibleToTurnInto) {
...
import "./dropdown-menu-PBSLBMZL.scss";
import { jsx as jsx18 } from "react/jsx-runtime";
function DropdownMenu({
  ...props
}) {
  return /* @__PURE__ */ jsx18(DropdownMenuPrimitive.Root, { modal: false, ...props });
}
function DropdownMenuPortal({
  ...props
}) {
  return /* @__PURE__ */ jsx18(DropdownMenuPrimitive.Portal, { ...props });
}
var DropdownMenuTrigger = forwardRef7(({ ...props }, ref) => /* @__PURE__ */ jsx18(DropdownMenuPrimitive.Trigger, { ref, ...props }));
...
var DropdownMenuSubContent = forwardRef7(({ className, portal = true, ...props }, ref) => {
  ...
  return portal ? /* @__PURE__ */ jsx18(DropdownMenuPortal, { ...typeof portal === "object" ? portal : {}, children: content }) : content;
});
...
import "./card-H7P4F6AT.scss";
import { jsx as jsx19 } from "react/jsx-runtime";
var Card = forwardRef8(
  ({ className, ...props }, ref) => {
    return /* @__PURE__ */ jsx19("div", { ref, className: cn("tiptap-card", className), ...props });
  }
);
...
var CardBody = forwardRef8(
  ({ className, ...props }, ref) => {
    return /* @__PURE__ */ jsx19("div", { ref, className: cn("tiptap-card-body", className), ...props });
  }
);
...
var HeadingDropdownMenu = forwardRef9(
  ({
    ...
    return /* @__PURE__ */ jsxs11(DropdownMenu, { modal: true, open: isOpen, onOpenChange: handleOpenChange, children: [
      /* @__PURE__ */ jsx20(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsx20(
        Button,
        {
          ...
          ...buttonProps,
          ref,
          children: children ? children : /* @__PURE__ */ jsxs11(Fragment4, { children: [
            /* @__PURE__ */ jsx20(Icon, { className: "tiptap-button-icon" }),
            /* @__PURE__ */ jsx20(ChevronDownIcon, { className: "tiptap-button-dropdown-small" })
          ] })
        }
      ) }),
      /* @__PURE__ */ jsx20(DropdownMenuContent, { align: "start", portal, children: /* @__PURE__ */ jsx20(Card, { children: /* @__PURE__ */ jsx20(CardBody, { children: /* @__PURE__ */ jsx20(ButtonGroup, { children: levels.map((level) => /* @__PURE__ */ jsx20(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsx20(
        HeadingButton,
        {
          editor,
          level,
    ...
    return /* @__PURE__ */ jsx22(
      Button,
      {
        ...
        children: children ?? /* @__PURE__ */ jsxs12(Fragment5, { children: [
          /* @__PURE__ */ jsx22(RenderIcon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx22("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx22(ImageShortcutBadge, { shortcutKeys })
        ] })
      }
    );
  }
...
function useIsBreakpoint(mode = "max", breakpoint = 768) {
  const [matches, setMatches] = useState9(void 0);
  useEffect6(() => {
...
import { forwardRef as forwardRef11, useCallback as useCallback8 } from "react";
import { Fragment as Fragment6, jsx as jsx24, jsxs as jsxs13 } from "react/jsx-runtime";
function ListShortcutBadge({
  type,
  shortcutKeys = LIST_SHORTCUT_KEYS[type]
}) {
  return /* @__PURE__ */ jsx24(Badge, { children: parseShortcutKeys({ shortcutKeys }) });
}
    ...
    return /* @__PURE__ */ jsx24(
      Button,
      {
        ...
        children: children ?? /* @__PURE__ */ jsxs13(Fragment6, { children: [
          /* @__PURE__ */ jsx24(Icon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx24("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx24(ListShortcutBadge, { type, shortcutKeys })
        ] })
      }
    );
  }
...
import { useCallback as useCallback9, useEffect as useEffect8, useState as useState11 } from "react";
...
function toggleList(editor, type) {
  ...
  try {
    ...
    if ((state.selection.empty || state.selection instanceof TextSelection3) && isPossibleToTurnInto) {
      const pos = findNodePosition({
        editor,
        node: state.selection.$anchor.node(1)
      })?.pos;
...
import { useEffect as useEffect9, useMemo as useMemo5, useState as useState12 } from "react";
var listOptions = [
  {
    label: "\u65E0\u5E8F\u5217\u8868",
    type: "bulletList",
...
function ListDropdownMenu({
  ...
  return /* @__PURE__ */ jsxs17(DropdownMenu, { open: isOpen, onOpenChange: handleOnOpenChange, children: [
    /* @__PURE__ */ jsx28(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs17(
      Button,
      {
        type: "button",
        "data-style": "ghost",
        ...
        children: [
          ...
          /* @__PURE__ */ jsx28(ChevronDownIcon, { className: "tiptap-button-dropdown-small" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsx28(DropdownMenuContent, { align: "start", portal, children: /* @__PURE__ */ jsx28(Card, { children: /* @__PURE__ */ jsx28(CardBody, { children: /* @__PURE__ */ jsx28(ButtonGroup, { children: filteredLists.map((option) => /* @__PURE__ */ jsx28(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsx28(
      ListButton,
      {
        editor,
        type: option.type,
...
import { Fragment as Fragment7, jsx as jsx29, jsxs as jsxs18 } from "react/jsx-runtime";
  ...
  ({
    ...
    return /* @__PURE__ */ jsx29(
      Button,
      {
        ...
        ...buttonProps,
        ref,
        children: children ?? /* @__PURE__ */ jsxs18(Fragment7, { children: [
          /* @__PURE__ */ jsx29(Icon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx29("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx29(BlockquoteShortcutBadge, { shortcutKeys })
        ] })
      }
    );
  }
...
import { useCallback as useCallback12, useEffect as useEffect10, useState as useState14 } from "react";
...
import { forwardRef as forwardRef13, useCallback as useCallback13 } from "react";
import { Fragment as Fragment8, jsx as jsx31, jsxs as jsxs20 } from "react/jsx-runtime";
function CodeBlockShortcutBadge({
  shortcutKeys = CODE_BLOCK_SHORTCUT_KEY
}) {
  return /* @__PURE__ */ jsx31(Badge, { children: parseShortcutKeys({ shortcutKeys }) });
}
var CodeBlockButton = forwardRef13(
  ({
    editor: providedEditor,
    text,
    hideWhenUnavailable = false,
    ...
    return /* @__PURE__ */ jsx31(
      Button,
      {
        ...
        ...buttonProps,
        ref,
        children: children ?? /* @__PURE__ */ jsxs20(Fragment8, { children: [
          /* @__PURE__ */ jsx31(Icon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx31("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx31(CodeBlockShortcutBadge, { shortcutKeys })
        ] })
      }
    );
  }
...
import { useCallback as useCallback14, useEffect as useEffect11, useState as useState15 } from "react";
...
var CodeBlockIcon = memo15(({ className, ...props }) => {
...
function toggleCodeBlock(editor) {
  ...
  try {
    ...
    if ((state.selection.empty || state.selection instanceof TextSelection5) && isPossibleToTurnInto) {
      const pos = findNodePosition({
        editor,
        node: state.selection.$anchor.node(1)
      })?.pos;
...
import { forwardRef as forwardRef15, useMemo as useMemo7, useRef as useRef5, useState as useState17 } from "react";
...
import "./popover-6ZQ2IAO2.scss";
import { jsx as jsx35 } from "react/jsx-runtime";
function Popover({
  ...props
}) {
  return /* @__PURE__ */ jsx35(PopoverPrimitive.Root, { ...props });
}
function PopoverTrigger({
  ...props
}) {
  return /* @__PURE__ */ jsx35(PopoverPrimitive.Trigger, { ...props });
}
...
import { forwardRef as forwardRef14, useCallback as useCallback15, useMemo as useMemo6 } from "react";
import "./color-highlight-button-IPEAVLDR.scss";
import { Fragment as Fragment9, jsx as jsx36, jsxs as jsxs22 } from "react/jsx-runtime";
function ColorHighlightShortcutBadge({
  shortcutKeys = COLOR_HIGHLIGHT_SHORTCUT_KEY
}) {
  return /* @__PURE__ */ jsx36(Badge, { children: parseShortcutKeys({ shortcutKeys }) });
}
var ColorHighlightButton = forwardRef14(
  ({
    editor: providedEditor,
    highlightColor,
    text,
    ...
    return /* @__PURE__ */ jsx36(
      Button,
      {
        ...
        ...buttonProps,
        ref,
        children: children ?? /* @__PURE__ */ jsxs22(Fragment9, { children: [
          /* @__PURE__ */ jsx36(
            "span",
            {
          ...
          showShortcut && /* @__PURE__ */ jsx36(ColorHighlightShortcutBadge, { shortcutKeys })
        ] })
      }
    );
  }
...
import { useCallback as useCallback16, useEffect as useEffect12, useState as useState16 } from "react";
...
var ColorHighlightPopoverButton = forwardRef15(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx37(
  Button,
  {
    type: "button",
    className,
    ...
    ref,
    ...props,
    children: children ?? /* @__PURE__ */ jsx37(HighlighterIcon, { className: "tiptap-button-icon" })
  }
));
...
function ColorHighlightPopoverContent({
  ...
  return /* @__PURE__ */ jsx37(
    Card,
    {
      ...
      children: /* @__PURE__ */ jsx37(CardBody, { style: isMobile ? { padding: 0 } : {}, children: /* @__PURE__ */ jsxs23(CardItemGroup, { orientation: "horizontal", children: [
        /* @__PURE__ */ jsx37(ButtonGroup, { orientation: "horizontal", children: colors.map((color, index) => /* @__PURE__ */ jsx37(
        ...
        /* @__PURE__ */ jsx37(Separator, {}),
        /* @__PURE__ */ jsx37(ButtonGroup, { orientation: "horizontal", children: /* @__PURE__ */ jsx37(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsx37(BanIcon, { className: "tiptap-button-icon" })
          }
        ) })
      ] }) })
    }
  ...
  return /* @__PURE__ */ jsxs23(Popover, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsx37(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx37(
      ColorHighlightPopoverButton,
      {
        ...
        tooltip: label,
        ...props,
        children: /* @__PURE__ */ jsx37(Icon, { className: "tiptap-button-icon" })
      }
    ) }),
    /* @__PURE__ */ jsx37(PopoverContent, { "aria-label": "\u9AD8\u4EAE\u989C\u8272", children: /* @__PURE__ */ jsx37(
...
import { forwardRef as forwardRef16, useCallback as useCallback17, useEffect as useEffect13, useState as useState18 } from "react";
...
import "./input-DOANY5FY.scss";
import { jsx as jsx42 } from "react/jsx-runtime";
function Input({ className, type, ...props }) {
  return /* @__PURE__ */ jsx42("input", { type, className: cn("tiptap-input", className), ...props });
}
function InputGroup({
  className,
  children,
  ...
  return /* @__PURE__ */ jsx42("div", { className: cn("tiptap-input-group", className), ...props, children });
}

// src/components/tiptap-ui/link-popover/link-popover.tsx
import { jsx as jsx43, jsxs as jsxs26 } from "react/jsx-runtime";
var LinkButton = forwardRef16(
  ({ className, children, ...props }, ref) => {
    return /* @__PURE__ */ jsx43(
      Button,
      {
        ...
        ref,
        ...props,
        children: children || /* @__PURE__ */ jsx43(LinkIcon, { className: "tiptap-button-icon" })
      }
    );
  }
);
    ...
    Card,
    {
      ...
      children: /* @__PURE__ */ jsx43(
        CardBody,
        {
          ...
          children: /* @__PURE__ */ jsxs26(CardItemGroup, { orientation: "horizontal", children: [
            /* @__PURE__ */ jsx43(InputGroup, { children: /* @__PURE__ */ jsx43(
              Input,
              {
                type: "url",
                placeholder: "\u7C98\u8D34\u94FE\u63A5...",
            ...
            /* @__PURE__ */ jsx43(ButtonGroup, { orientation: "horizontal", children: /* @__PURE__ */ jsx43(
              Button,
              {
                type: "button",
                onClick: setLink,
                ...
                "data-style": "ghost",
                children: /* @__PURE__ */ jsx43(CornerDownLeftIcon, { className: "tiptap-button-icon" })
              }
            ) }),
            /* @__PURE__ */ jsx43(Separator, {}),
            /* @__PURE__ */ jsxs26(ButtonGroup, { orientation: "horizontal", children: [
              /* @__PURE__ */ jsx43(
                Button,
                {
                  type: "button",
                  ...
                  disabled: !url && !isActive,
                  "data-style": "ghost",
                  children: /* @__PURE__ */ jsx43(ExternalLinkIcon, { className: "tiptap-button-icon" })
                }
              ),
              /* @__PURE__ */ jsx43(
                Button,
                {
                  ...
                  disabled: !url && !isActive,
                  "data-style": "ghost",
                  children: /* @__PURE__ */ jsx43(TrashIcon, { className: "tiptap-button-icon" })
                }
              )
            ] })
          ] })
...
var LinkContent = ({ editor }) => {
  ...
  return /* @__PURE__ */ jsx43(LinkMain, { ...linkPopover });
};
var LinkPopover = forwardRef16(
  ({
    editor: providedEditor,
    hideWhenUnavailable = false,
    onSetLink,
    ...
    return /* @__PURE__ */ jsxs26(Popover, { open: isOpen, onOpenChange: handleOnOpenChange, children: [
      /* @__PURE__ */ jsx43(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx43(
        LinkButton,
        {
          ...
          ...buttonProps,
          ref,
          children: children ?? /* @__PURE__ */ jsx43(Icon, { className: "tiptap-button-icon" })
        }
      ) }),
      /* @__PURE__ */ jsx43(PopoverContent, { children: /* @__PURE__ */ jsx43(
        LinkMain,
        {
          url,
          setUrl,
...
import { useCallback as useCallback18, useEffect as useEffect14, useState as useState19 } from "react";
...
function useLinkHandler(props) {
  ...
  const [url, setUrl] = useState19(null);
  useEffect14(() => {
    if (!editor) return;
...
import { forwardRef as forwardRef17, useCallback as useCallback19 } from "react";
import { Fragment as Fragment10, jsx as jsx44, jsxs as jsxs27 } from "react/jsx-runtime";
function MarkShortcutBadge({
  type,
  shortcutKeys = MARK_SHORTCUT_KEYS[type]
}) {
  return /* @__PURE__ */ jsx44(Badge, { children: parseShortcutKeys({ shortcutKeys }) });
}
var MarkButton = forwardRef17(
  ({
    editor: providedEditor,
    type,
    text,
    ...
    return /* @__PURE__ */ jsx44(
      Button,
      {
        ...
        ...buttonProps,
        ref,
        children: children ?? /* @__PURE__ */ jsxs27(Fragment10, { children: [
          /* @__PURE__ */ jsx44(Icon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx44("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx44(MarkShortcutBadge, { type, shortcutKeys })
        ] })
      }
    );
  }
...
import { useCallback as useCallback20, useEffect as useEffect15, useState as useState20 } from "react";
...
import { forwardRef as forwardRef18, useCallback as useCallback21 } from "react";
import { Fragment as Fragment11, jsx as jsx52, jsxs as jsxs32 } from "react/jsx-runtime";
function TextAlignShortcutBadge({
  align,
  shortcutKeys = TEXT_ALIGN_SHORTCUT_KEYS[align]
}) {
  return /* @__PURE__ */ jsx52(Badge, { children: parseShortcutKeys({ shortcutKeys }) });
}
var TextAlignButton = forwardRef18(
  ({
    editor: providedEditor,
    align,
    text,
    ...
    return /* @__PURE__ */ jsx52(
      Button,
      {
        ...
        ...buttonProps,
        ref,
        children: children ?? /* @__PURE__ */ jsxs32(Fragment11, { children: [
          /* @__PURE__ */ jsx52(RenderIcon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx52("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx52(
...
import { useCallback as useCallback22, useEffect as useEffect16, useState as useState21 } from "react";
...
import { Fragment as Fragment12, jsx as jsx57, jsxs as jsxs37 } from "react/jsx-runtime";
function HistoryShortcutBadge({
  action,
  shortcutKeys = UNDO_REDO_SHORTCUT_KEYS[action]
}) {
  return /* @__PURE__ */ jsx57(Badge, { children: parseShortcutKeys({ shortcutKeys }) });
}
var UndoRedoButton = forwardRef19(
  ({
    editor: providedEditor,
    action,
    text,
    ...
    return /* @__PURE__ */ jsx57(
      Button,
      {
        ...
        ...buttonProps,
        ref,
        children: children ?? /* @__PURE__ */ jsxs37(Fragment12, { children: [
          /* @__PURE__ */ jsx57(Icon, { className: "tiptap-button-icon" }),
          text && /* @__PURE__ */ jsx57("span", { className: "tiptap-button-text", children: text }),
          showShortcut && /* @__PURE__ */ jsx57(
...
import { useCallback as useCallback24, useEffect as useEffect17, useState as useState22 } from "react";
...
import { useRef as useRef6, useEffect as useEffect18 } from "react";
...
function useWindowSize() {
  const [windowSize, setWindowSize] = useState23({
    width: 0,
    height: 0,
    offsetTop: 0,
    offsetLeft: 0,
...
import { useCallback as useCallback25, useEffect as useEffect20, useState as useState24 } from "react";
var initialRect = {
  x: 0,
  y: 0,
  width: 0,
...
function useElementRect({
  ...
  const [rect, setRect] = useState24(initialRect);
...
function ThemeToggle() {
  ...
  return /* @__PURE__ */ jsx63(
    Button,
    {
      ...
      "data-style": "ghost",
      children: isDarkMode ? /* @__PURE__ */ jsx63(MoonStarIcon, { className: "tiptap-button-icon" }) : /* @__PURE__ */ jsx63(SunIcon, { className: "tiptap-button-icon" })
    }
  );
}

// src/components/tiptap-templates/simple/simple-editor.tsx
import "./simple-editor-WEOGV43Y.scss";
...
var MainToolbarContent = ({
  ...
  if (toolbarPreset === "annotation") {
    return /* @__PURE__ */ jsxs40(Fragment13, { children: [
      /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
        /* @__PURE__ */ jsx64(UndoRedoButton, { action: "undo" }),
        /* @__PURE__ */ jsx64(UndoRedoButton, { action: "redo" })
      ] }),
      /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
      /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
        /* @__PURE__ */ jsx64(HeadingButton, { level: 1 }),
        /* @__PURE__ */ jsx64(HeadingButton, { level: 2 }),
        /* @__PURE__ */ jsx64(HeadingButton, { level: 3 })
      ] }),
      /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
      /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
        /* @__PURE__ */ jsx64(MarkButton, { type: "bold" }),
        /* @__PURE__ */ jsx64(MarkButton, { type: "italic" }),
        /* @__PURE__ */ jsx64(MarkButton, { type: "strike" }),
        /* @__PURE__ */ jsx64(MarkButton, { type: "code" })
      ] }),
      /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
      /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
        /* @__PURE__ */ jsx64(ListButton, { type: "bulletList" }),
        /* @__PURE__ */ jsx64(ListButton, { type: "orderedList" }),
        /* @__PURE__ */ jsx64(ListButton, { type: "taskList" })
      ] }),
      /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
      /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
        /* @__PURE__ */ jsx64(BlockquoteButton, {}),
        /* @__PURE__ */ jsx64(CodeBlockButton, {})
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxs40(Fragment13, { children: [
    !compactToolbar ? /* @__PURE__ */ jsx64(Spacer, {}) : null,
    /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
      /* @__PURE__ */ jsx64(UndoRedoButton, { action: "undo" }),
      /* @__PURE__ */ jsx64(UndoRedoButton, { action: "redo" })
    ] }),
    /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
    /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
      /* @__PURE__ */ jsx64(HeadingDropdownMenu, { levels: [1, 2, 3, 4], portal: isMobile }),
      /* @__PURE__ */ jsx64(
        ListDropdownMenu,
        {
          types: ["bulletList", "orderedList", "taskList"],
    ...
    /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
      ...
      /* @__PURE__ */ jsx64(MarkButton, { type: "strike" }),
      /* @__PURE__ */ jsx64(MarkButton, { type: "code" }),
      /* @__PURE__ */ jsx64(MarkButton, { type: "underline" }),
      !isMobile ? /* @__PURE__ */ jsx64(ColorHighlightPopover, {}) : /* @__PURE__ */ jsx64(ColorHighlightPopoverButton, { onClick: onHighlighterClick }),
      !isMobile ? /* @__PURE__ */ jsx64(LinkPopover, {}) : /* @__PURE__ */ jsx64(LinkButton, { onClick: onLinkClick })
    ] }),
    /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
    /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
      /* @__PURE__ */ jsx64(MarkButton, { type: "superscript" }),
      /* @__PURE__ */ jsx64(MarkButton, { type: "subscript" })
    ] }),
    /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
    /* @__PURE__ */ jsxs40(ToolbarGroup, { children: [
      /* @__PURE__ */ jsx64(TextAlignButton, { align: "left" }),
      /* @__PURE__ */ jsx64(TextAlignButton, { align: "center" }),
      /* @__PURE__ */ jsx64(TextAlignButton, { align: "right" }),
      /* @__PURE__ */ jsx64(TextAlignButton, { align: "justify" })
    ] }),
    /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
    /* @__PURE__ */ jsx64(ToolbarGroup, { children: /* @__PURE__ */ jsx64(ImageUploadButton, { text: "\u56FE\u7247" }) }),
    !compactToolbar ? /* @__PURE__ */ jsx64(Spacer, {}) : null,
    isMobile && /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
    showThemeToggle && /* @__PURE__ */ jsx64(ToolbarGroup, { children: /* @__PURE__ */ jsx64(ThemeToggle, {}) })
  ] });
};
var MobileToolbarContent = ({
  ...
  /* @__PURE__ */ jsx64(ToolbarGroup, { children: /* @__PURE__ */ jsxs40(Button, { "data-style": "ghost", onClick: onBack, children: [
    /* @__PURE__ */ jsx64(ArrowLeftIcon, { className: "tiptap-button-icon" }),
    type === "highlighter" ? /* @__PURE__ */ jsx64(HighlighterIcon, { className: "tiptap-button-icon" }) : /* @__PURE__ */ jsx64(LinkIcon, { className: "tiptap-button-icon" })
  ] }) }),
  /* @__PURE__ */ jsx64(ToolbarSeparator, {}),
  type === "highlighter" ? /* @__PURE__ */ jsx64(ColorHighlightPopoverContent, {}) : /* @__PURE__ */ jsx64(LinkContent, {})
] });
function SimpleEditor({
  ...
  const [isToolbarScrolled, setIsToolbarScrolled] = useState26(false);
      ...
      children: /* @__PURE__ */ jsxs40(EditorContext.Provider, { value: { editor }, children: [
        /* @__PURE__ */ jsx64(
          Toolbar,
          {
            ...
            children: mobileView === "main" ? /* @__PURE__ */ jsx64(
              MainToolbarContent,
              {
